...
class LevelManager:
    ...
    def next_level(self):
        ...
        if next_level < len(self.levels):
            self.get_current().layout.switch_world(self.levels[next_level])
            self.actual_level = next_level

    def first_level(self):
        self.get_current().layout.switch_world(self.levels[0])
        self.actual_level = 0
    ...
    def same_level(self):
        self.get_current().layout.switch_world(self.levels[self.actual_level], reset = True)
